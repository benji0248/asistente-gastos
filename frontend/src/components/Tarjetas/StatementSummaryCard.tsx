import { Calendar, CreditCard, DollarSign, Trash2, Wallet } from "lucide-react"
...
export function StatementSummaryCard({
  ...
  return (
    <div className="relative rounded-2xl border border-border/60 bg-card p-4 shadow-sm space-y-4 sm:p-6 sm:space-y-6">
      {onClear && (
        <Button
          type="button"
          variant="ghost"
          ...
          onClick={onClear}
          aria-label="Quitar resumen"
          title="Quitar resumen"
        >
